...
![Cover — Claude Code deep dive: Loop engineering](images/00-cover.jpg)
...
![What a loop actually does — find work, hand it to the agent, check result, record what happened, decide next move](images/01-what-a-loop-does.png)
...
![Osmani's six parts of a loop](images/02-six-parts.png)
...
![The four conditions](images/03-four-conditions.png)
...
![The 30-second loop check](images/04-30-second-loop-check.png)
...
![Claude Code automation primitives](images/05-automations-claude-code.jpg)
...
![Worktrees in action (animated GIF in the original — static thumbnail shown)](images/06-worktrees-gif-thumb.jpg)
...
![Connectors via MCP](images/08-connectors.jpg)
...
![Sub-agents: maker vs checker](images/09-subagents.png)
...
![The minimum viable loop](images/11-minimum-viable-loop.png)
...
![The Ralph Wiggum loop](images/12-ralph-wiggum.jpg)
