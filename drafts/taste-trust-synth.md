...
Before writing a single line of code, a founder must ask: *Would this product survive if the next base model release is 10\\times more intelligent, 100\\times cheaper, and natively accepts multi-hour context windows?*  
...
When designing products, founders must practice "capability budgeting." This is the discipline of architecting software assuming that the underlying model substrate will improve by N\\times every M months.  
